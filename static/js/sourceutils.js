...
(function (SourceUtils) {
  const ResourcePage = /** @class */ (function () {
    ...
    ResourcePage.prototype.load = function (index, callback) {
      ...
      this.toLoad.push({ index, callback });
    };
  ...
  const PagedLoader = /** @class */ (function () {
    ...
    PagedLoader.prototype.update = function (requestQuota) {
      ...
      const _loop_1 = function () {
        const next = this_1.getNextToLoad();
        if (next == null) { return 'break'; }
        let lastProgress = 0;
        ++this_1.active;
...
var SourceUtils;
(function (SourceUtils) {
  const AmbientPage = /** @class */ (function (_super) {
  ...
  const AmbientLoader = /** @class */ (function (_super) {
...
var SourceUtils;
(function (SourceUtils) {
  const WebGame = Facepunch.WebGame;
  let LeafFlags;
  (function (LeafFlags) {
  ...
  var BspLeaf = /** @class */ (function (_super) {
    ...
    BspLeaf.prototype.getAmbientCube = function (pos, outSamples, callback) {
      ...
      if (samples == null) {
        if (callback != null) {
          const leafCopy_1 = this;
          this.viewer.ambientLoader.load(this.index, function (value) {
            if (value.length > 0) {
              if (pos != null) { leafCopy_1.getAmbientCube(pos, outSamples); }
              callback(true);
            } else {
              callback(false);
            }
  ...
  const BspModel = /** @class */ (function (_super) {
  ...
  const BspModelPage = /** @class */ (function (_super) {
    __extends(BspModelPage, _super);
    function BspModelPage (viewer, page) {
      const _this = _super.call(this, page) || this;
      _this.viewer = viewer;
      return _this;
    }
  ...
  const BspModelLoader = /** @class */ (function (_super) {
...
(function (SourceUtils) {
  const WebGame = Facepunch.WebGame;
  const DispGeometryPage = /** @class */ (function (_super) {
    ...
    DispGeometryPage.prototype.onLoadValues = function (page) {
      ...
      const _loop_2 = function (i, iEnd) {
        const matGroup = page.materials[i];
        const mat = this_2.viewer.mapMaterialLoader.loadMaterial(matGroup.material);
  ...
  const DispGeometryLoader = /** @class */ (function (_super) {
...
(function (SourceUtils) {
  const WebGame = Facepunch.WebGame;
  const LeafGeometryPage = /** @class */ (function (_super) {
    ...
    LeafGeometryPage.prototype.onLoadValues = function (page) {
      ...
      const _loop_3 = function (i, iEnd) {
        const matGroup = page.materials[i];
        const mat = this_3.viewer.mapMaterialLoader.loadMaterial(matGroup.material);
        const data = WebGame.MeshManager.decompress(matGroup.meshData);
    ...
    LeafGeometryPage.prototype.onGetValue = function (index) {
      ...
      const handles = new Array(leafFaces.length);
  ...
  const LeafGeometryLoader = /** @class */ (function (_super) {
...
(function (SourceUtils) {
  ...
  const Map = /** @class */ (function () {
    ...
    Map.prototype.getPvsEntitiesInCluster = function (cluster) {
      ...
      for (let _i = 0, _a = this.pvsEntities; _i < _a.length; _i++) {
        const ent = _a[_i];
    ...
    Map.prototype.getLeafAt = function (pos, callback) {
      ...
      if (this.worldspawn == null || !this.worldspawn.model.isLoaded()) {
        if (callback != null) {
          const posCopy_1 = new Facepunch.Vector3().copy(pos);
    ...
    Map.prototype.update = function (dt) {
      if (this.worldspawnLoadedCallbacks.length > 0 && this.worldspawn != null && this.worldspawn.model.isLoaded()) {
        for (let _i = 0, _a = this.worldspawnLoadedCallbacks; _i < _a.length; _i++) {
    ...
    Map.prototype.populateDrawList = function (drawList, pvsRoot) {
      ...
      for (let _b = 0, vis_1 = vis; _b < vis_1.length; _b++) {
        const cluster = vis_1[_b];
        const ents = this.getPvsEntitiesInCluster(cluster);
        for (let _c = 0, ents_1 = ents; _c < ents_1.length; _c++) {
          var ent = ents_1[_c];
...
(function (SourceUtils) {
  const WebGame = Facepunch.WebGame;
  const MapMaterialPage = /** @class */ (function (_super) {
  ...
  const MapMaterialLoader = /** @class */ (function (_super) {
...
(function (SourceUtils) {
  ...
  const MapViewer = /** @class */ (function (_super) {
    __extends(MapViewer, _super);
    function MapViewer (container) {
      const _this = _super.call(this, container) || this;
    ...
    MapViewer.prototype.onInitialize = function () {
      ...
      const deviceRotate = function (x, y, z, period, toRadians) {
        x *= toRadians / period;
        y *= toRadians / period;
        z *= toRadians / period;
    ...
    MapViewer.prototype.toggleFullscreen = function () {
      ...
      if (document.fullscreenElement === container || document.webkitFullscreenElement === container || doc.mozFullScreenElement === container) {
        if (document.exitFullscreen) { document.exitFullscreen(); } else if (document.webkitExitFullscreen) { document.webkitExitFullscreen(); } else if (doc.mozCancelFullScreen) { doc.mozCancelFullScreen(); }
    ...
    MapViewer.prototype.onSetDebugText = function (className, value) {
      const elem = this.debugPanel.getElementsByClassName(className)[0];
      if (elem == null) { return; }
      elem.textContent = value;
      if (className === 'debug-loadpercent' && parseInt(value) >= 100) {
        const loading = this.debugPanel.getElementsByClassName('debug-loading')[0];
        if (loading != null) {
    ...
    MapViewer.prototype.onUpdateFrame = function (dt) {
      ...
      if (this.showDebugPanel !== this.debugPanelVisible) {
        ...
        if (this.debugPanel != null) {
          if (this.showDebugPanel) { this.debugPanel.style.display = null; } else { this.debugPanel.style.display = 'none'; }
        }
      }
...
(function (SourceUtils) {
  const WebGame = Facepunch.WebGame;
  const SkyCube = /** @class */ (function (_super) {
...
(function (SourceUtils) {
  const WebGame = Facepunch.WebGame;
  const StudioModel = /** @class */ (function (_super) {
    ...
    StudioModel.getOrCreateMatGroup = function (matGroups, attribs) {
      for (let _i = 0, matGroups_1 = matGroups; _i < matGroups_1.length; _i++) {
        const matGroup = matGroups_1[_i];
    ...
    StudioModel.sampleAmbientCube = function (leaf, pos, normal) {
      ...
      rgb.add(sample.x * mul, sample.y * mul, sample.z * mul);
      const r = SourceUtils.ColorConversion.linearToScreenGamma(rgb.x);
      const g = SourceUtils.ColorConversion.linearToScreenGamma(rgb.y);
      const b = SourceUtils.ColorConversion.linearToScreenGamma(rgb.z);
      return r | (g << 8) | (b << 16);
    };
    StudioModel.prototype.createMeshHandles = function (bodyPartIndex, transform, lighting, albedoModulation) {
      ...
      const handles = [];
      const matGroups = [];
      if (albedoModulation === undefined) { albedoModulation = 0xFFFFFF; } else { albedoModulation &= 0xFFFFFF; }
      const albedoR = albedoModulation & 0xFF;
      const albedoG = (albedoModulation >> 8) & 0xFF;
      const albedoB = (albedoModulation >> 16) & 0xFF;
      const hasAmbientLighting = lighting != null && lighting.isLeaf;
      const hasVertLighting = lighting != null && !hasAmbientLighting;
      const leaf = hasAmbientLighting ? lighting : null;
      const tempPos = new Facepunch.Vector4();
      const tempNormal = new Facepunch.Vector4();
      for (let _i = 0, _a = bodyPart.models; _i < _a.length; _i++) {
        const model = _a[_i];
        for (let _b = 0, _c = model.meshes; _b < _c.length; _b++) {
          const mesh = _c[_b];
          ...
          const vertLighting = hasVertLighting ? lighting[mesh.meshId] : null;
          const vertData = dstGroup.vertices;
          for (let i = newElem.vertexOffset, iEnd = newElem.vertexOffset + newElem.vertexCount, j = 0; i < iEnd; i += vertLength, ++j) {
      ...
      for (let _d = 0, matGroups_2 = matGroups; _d < matGroups_2.length; _d++) {
        const matGroup = matGroups_2[_d];
  ...
  const StudioModelPage = /** @class */ (function (_super) {
    ...
    StudioModelPage.prototype.onLoadValues = function (page) {
      ...
      for (let i = 0, iEnd = page.materials.length; i < iEnd; ++i) {
        ...
        for (let _i = 0, _a = this.matGroups[i].elements; _i < _a.length; _i++) {
          const element = _a[_i];
  ...
  const StudioModelLoader = /** @class */ (function (_super) {
  ...
  const VertexLightingPage = /** @class */ (function (_super) {
    ...
    VertexLightingPage.prototype.onLoadValues = function (page) {
      ...
      for (let i = 0, iEnd = page.props.length; i < iEnd; ++i) {
        ...
        const dstProp = this.props[i] = srcProp == null ? null : new Array(srcProp.length);
  ...
  const VertexLightingLoader = /** @class */ (function (_super) {
...
var SourceUtils;
(function (SourceUtils) {
  const ColorConversion = /** @class */ (function () {
    ...
    ColorConversion.linearToScreenGamma = function (f) {
      ...
      if (index < 0) { index = 0; } else if (index > 1023) { index = 1023; }
...
var SourceUtils;
(function (SourceUtils) {
  const VisPage = /** @class */ (function (_super) {
  ...
  const VisLoader = /** @class */ (function (_super) {
...
(function (SourceUtils) {
  ...
  let Entities;
  (function (Entities) {
    const Entity = /** @class */ (function (_super) {
      __extends(Entity, _super);
      function Entity (map, info) {
        const _this = _super.call(this, true) || this;
        _this.map = map;
    ...
    const PvsEntity = /** @class */ (function (_super) {
      __extends(PvsEntity, _super);
      function PvsEntity (map, info) {
        const _this = _super.call(this, map, info) || this;
...
(function (SourceUtils) {
  let Entities;
  (function (Entities) {
    const BrushEntity = /** @class */ (function (_super) {
...
(function (SourceUtils) {
  ...
  let Entities;
  (function (Entities) {
    const Camera = /** @class */ (function (_super) {
      __extends(Camera, _super);
      function Camera (viewer, fov) {
        const _this = _super.call(this, viewer, fov, viewer.getWidth() / viewer.getHeight(), 1, 8192) || this;
    ...
    const SkyCamera = /** @class */ (function (_super) {
      __extends(SkyCamera, _super);
      function SkyCamera (viewer, info) {
        const _this = _super.call(this, viewer, 60) || this;
        ...
        if (info.fogEnabled) {
          ...
          if (info.farZ !== 0) { _this.setFar(info.farZ); }
        }
        return _this;
      }
    ...
    const ShadowCamera = /** @class */ (function (_super) {
      __extends(ShadowCamera, _super);
      function ShadowCamera (viewer, targetCamera) {
        const _this = _super.call(this, viewer, 1, 1, 0, 1) || this;
        _this.viewer = viewer;
...
(function (SourceUtils) {
  let Entities;
  (function (Entities) {
    const Displacement = /** @class */ (function (_super) {
      ...
      Displacement.prototype.onAddToDrawList = function (list) {
        ...
        if (!this.isLoaded) {
          ...
          this.map.viewer.dispGeometryLoader.load(this.index, function (handle) {
            if (handle != null) { _this.drawable.addMeshHandles([handle]); }
          });
        }
        _super.prototype.onAddToDrawList.call(this, list);
      };
...
(function (SourceUtils) {
  ...
  let Entities;
  (function (Entities) {
    const KeyframeRope = /** @class */ (function (_super) {
    ...
    const MoveRope = /** @class */ (function (_super) {
      ...
      MoveRope.prototype.generateMesh = function () {
        ...
        this.map.getLeafAt(mid, function (leaf) {
          const ambient = _this.material.properties.ambient = new Array(6);
          leaf.getAmbientCube(mid, ambient, function (success) {
            if (success) { _this.map.viewer.forceDrawListInvalidation(false); }
          });
        });
        mesh.elements.push({
          mode: WebGame.DrawMode.Triangles,
...
(function (SourceUtils) {
  let Entities;
  (function (Entities) {
    const StaticProp = /** @class */ (function (_super) {
...
(function (SourceUtils) {
  let Entities;
  (function (Entities) {
    const Worldspawn = /** @class */ (function (_super) {
...
(function (SourceUtils) {
  ...
  let Shaders;
  (function (Shaders) {
    const BaseMaterial = /** @class */ (function () {
    ...
    const BaseShaderProgram = /** @class */ (function (_super) {
...
(function (SourceUtils) {
  ...
  let Shaders;
  (function (Shaders) {
    const ModelBaseMaterial = /** @class */ (function (_super) {
    ...
    const ModelBase = /** @class */ (function (_super) {
...
(function (SourceUtils) {
  ...
  let Shaders;
  (function (Shaders) {
    const LightmappedBaseMaterial = /** @class */ (function (_super) {
    ...
    const LightmappedBase = /** @class */ (function (_super) {
...
(function (SourceUtils) {
  ...
  let Shaders;
  (function (Shaders) {
    const Lightmapped2WayBlendMaterial = /** @class */ (function (_super) {
    ...
    const Lightmapped2WayBlend = /** @class */ (function (_super) {
      __extends(Lightmapped2WayBlend, _super);
      function Lightmapped2WayBlend (context) {
        const _this = _super.call(this, context, Lightmapped2WayBlendMaterial) || this;
...
(function (SourceUtils) {
  let Shaders;
  (function (Shaders) {
    const LightmappedGenericMaterial = /** @class */ (function (_super) {
    ...
    const LightmappedGeneric = /** @class */ (function (_super) {
      __extends(LightmappedGeneric, _super);
      function LightmappedGeneric (context) {
        const _this = _super.call(this, context, LightmappedGenericMaterial) || this;
        const gl = context;
        _this.includeShaderSource(gl.VERTEX_SHADER, '\n                    void main()\n                    {\n                        LightmappedBase_main();\n                    }');
...
(function (SourceUtils) {
  ...
  let Shaders;
  (function (Shaders) {
    const SkyMaterial = /** @class */ (function (_super) {
    ...
    const Sky = /** @class */ (function (_super) {
      __extends(Sky, _super);
      function Sky (context) {
        const _this = _super.call(this, context, SkyMaterial) || this;
        _this.uProjection = _this.addUniform('uProjection', WebGame.UniformMatrix4);
        _this.uView = _this.addUniform('uView', WebGame.UniformMatrix4);
...
(function (SourceUtils) {
  ...
  let Shaders;
  (function (Shaders) {
    const SplineRopeMaterial = /** @class */ (function (_super) {
    ...
    const SplineRope = /** @class */ (function (_super) {
      __extends(SplineRope, _super);
      function SplineRope (context) {
        const _this = _super.call(this, context, SplineRopeMaterial) || this;
...
(function (SourceUtils) {
  let Shaders;
  (function (Shaders) {
    const UnlitGenericMaterial = /** @class */ (function (_super) {
    ...
    const UnlitGeneric = /** @class */ (function (_super) {
      __extends(UnlitGeneric, _super);
      function UnlitGeneric (context) {
        const _this = _super.call(this, context, UnlitGenericMaterial) || this;
        const gl = context;
        _this.includeShaderSource(gl.VERTEX_SHADER, '\n                    void main()\n                    {\n                        ModelBase_main();\n                    }');
...
(function (SourceUtils) {
  ...
  let Shaders;
  (function (Shaders) {
    const VertexLitGenericMaterial = /** @class */ (function (_super) {
    ...
    const VertexLitGeneric = /** @class */ (function (_super) {
      __extends(VertexLitGeneric, _super);
      function VertexLitGeneric (context) {
        const _this = _super.call(this, context, VertexLitGenericMaterial) || this;
        const gl = context;
...
(function (SourceUtils) {
  ...
  let Shaders;
  (function (Shaders) {
    const WaterMaterial = /** @class */ (function (_super) {
    ...
    const Water = /** @class */ (function (_super) {
      __extends(Water, _super);
      function Water (context) {
        const _this = _super.call(this, context, WaterMaterial) || this;
...
(function (SourceUtils) {
  ...
  let Shaders;
  (function (Shaders) {
    const WorldTwoTextureBlendMaterial = /** @class */ (function (_super) {
    ...
    const WorldTwoTextureBlend = /** @class */ (function (_super) {
      __extends(WorldTwoTextureBlend, _super);
      function WorldTwoTextureBlend (context) {
        const _this = _super.call(this, context, WorldTwoTextureBlendMaterial) || this;
